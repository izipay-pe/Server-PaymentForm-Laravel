...
<head>
  ...
  <script type="text/javascript"
    ...
    kr-public-key="<?php echo e($publicKey); ?>"
    ...
    <div class="center-column col-md-6">
      <section class="payment-form">
        ...
        <div id="micuentawebstd_rest_wrapper">
          ...
          <div class="kr-embedded" kr-popin kr-form-token="<?php echo e($formToken); ?>">
            <?php echo csrf_field(); ?>
          </div>
          <!---->
        </div>
...
</html><?php /**PATH C:\laragon\www\Popin-PaymentForm-Laravel-main\resources\views/izipay/checkout.blade.php ENDPATH**/ ?>