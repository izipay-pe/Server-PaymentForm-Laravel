    ...
    <div class="center-column col-md-6">
      <section class="payment-form">
        ...
        <div id="micuentawebstd_rest_wrapper">
          ...
          <div class="kr-embedded" kr-form-token="<?php echo e($formToken); ?>">
            <?php echo csrf_field(); ?>
          </div>
          <!---->
        </div>
...
</html><?php /**PATH C:\laragon\www\Embedded-PaymentForm-Laravel-main\resources\views/izipay/checkout.blade.php ENDPATH**/ ?>